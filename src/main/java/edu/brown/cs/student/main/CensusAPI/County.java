...
/**
 * This class describes the county objects that are wrapper classes for the string information contained about
 * a county in a certain state.
 */
...
public class County {
  ...
  /**
   * The constructor of the county that holds 3 parameters: the name of the county, name of the state
   * and the countyCode, all represented as strings.
